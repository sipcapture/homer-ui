...
@Component({
    selector: 'app-page-ipalias',
    templateUrl: './page-ipalias.component.html',
    styleUrls: ['./page-ipalias.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})

export class PageIpAliasComponent implements OnInit, OnDestroy, AfterViewInit {
    isLoading = false;
    isAdmin = false;
    ...
    constructor(
        ...
        private service: PreferenceIpAliasService,
    ...
    async updateData() {
        ...
        this.cdr.detectChanges();
                try {
                  response = await this.service.getAll(0);
                    this.isLoading = false;
                    this.dataSource.data =
                        response.data.map((item: PreferenceIpAlias) => ({
                            UUID: item.uuid,
    ...
    settingDialog(item: any = null, type?: string) {
        ...
        this.openDialog(DialogIpAliasComponent, Functions.cloneObject(item), onOpenDialog, isCopy);
    }
