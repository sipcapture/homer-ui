...
50*f);d.canvas.width=j;d.canvas.height=g;var m={},b={},h={width:0};d.clearRect(0,0,c.canvas.width,c.canvas.height);d.fillStyle="#FFF";d.opacity=0.2;d.fillRect(0,0,c.canvas.width,c.canvas.height);var j=j-20,g=g-30,d=Object.keys(e.hosts).length-1,k=j/(d?d:1),q=Object.keys(e.hosts).length;angular.forEach(e.hosts,function(a,c){var alias = undefined;angular.forEach(e.calldata,function(cd) {if (alias != undefined) return; if(cd.src_id==c){alias=cd.source_alias;port=cd.src_port;return;}if(cd.dst_id==c){alias=cd.destination_alias;port=cd.dst_port;return;}});a=parseInt(a);b={LineColor:"#000",LineWidth:1};b.StartX=a*k+10;b.StartY=65;b.EndX=a*k+10;b.EndY=g;u(b);m[c]=b;b={TextColor:"#666666"};b.Text=alias==undefined?c:alias+':'+port;b.Font="normal 11px Arial";b.textAlign=
"start";b.StartY=60;h=s(b);var d=a*k-h.width/2+10,f=a*k-20;0==a?(d=a*k,f=a*k):a==q-1&&(d=a*k-h.width+15,f=a*k-30);b.StartX=d;r(b);i.push({x1:b.StartX,y1:b.StartY-10,x2:b.StartX+h.width,y2:b.StartY+10,type:"host",alias:alias});d=e.uac[c];b={};b.ImageSrc=d&&d.image?"img/gateways/"+d.image+".jpg":"img/gateways/sipgateway.jpg";b.StartY=2;b.textAlign="start";b.StartX=f;w(b)});var g=g-130,n=g/(e.calldata.length-1?e.calldata.length-1:1);50>n&&(n=50);var p=0,l,t;angular.forEach(e.calldata,function(a){l=m[a.src_id];t=m[a.dst_id];b={LineColor:"#000",LineWidth:1};b.StartX=l.StartX;b.StartY=p*n+110;b.EndX=t.StartX;b.EndY=p*n+110;v(b);b={};b.TextColor=a.msg_color;b.Text=""+(p+1)+": "+a.method_text;b.Font="12px Futura, Helvetica, Arial";h=s(b);b.StartY=p*n+107;b.StartX=l.StartX<t.StartX?l.StartX+20:l.StartX-20-h.width;b.textAlign="start";r(b);i.push({x1:b.StartX-10,y1:b.StartY-10,x2:b.StartX+h.width,y2:b.StartY+10,type:"message",data:a});b={TextColor:"#C0C0C0"};b.Text=x("date")(new Date(a.micro_ts/1E3),"yyyy-MM-dd HH:mm:ss.sss");
