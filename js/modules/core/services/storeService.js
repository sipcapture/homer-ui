	...
	'$http',
        ...
        function ($q, $http, eventbus) 
        {
                ...
                var getAll = function () 
                {
                        ...
                        var defer = $q.defer();                                                            
                        $http.get('api/dashboard/store').then(
        			/* good response */
	                    function (results) {
			...
			$http.get('api/dashboard/store/' + id)
			...
			return deferred.promise;
                ...
                makeMenu = function (id, data) 
                {
                        ...
                        var defer = $q.defer();                                                            
                        $http.post('api/dashboard/menu/'+id, data).then(
        			/* good response */
	                    function (results) {
	                        defer.resolve(results.data);                                                                        
                            },
                ...
                setFunc = function (id, data) 
                {
                        ...
                        var defer = $q.defer();                                                            
                        $http.post('api/dashboard/store/'+id, data).then(
        			/* good response */
	                    function (results) {
	                        defer.resolve(results.data);                                                                        
                            },
                ...
                deleteFunc = function (id, data) 
                {
                        ...
                        var defer = $q.defer();                                                            
                        $http.delete('api/dashboard/store/'+id).then(
        			/* good response */
	                    function (results) {
	                        defer.resolve(results.data);                                                                        
                            },
